...
def _draw_cottage_overlays(surf, W, H, hour, now):
    ...
    _book_data = [
        ((75,105,168),(50, 75,138), int(W*432/800)+25, int(H* 73/480), "Mem"),
        ((158, 65, 58),(125, 45, 42), int(W*460/800)+25, int(H* 73/480), "Sto"),
        ((58, 118, 62),( 40, 85, 44), int(W*432/800)+25, int(H*135/480), "Ske"),
    ]
