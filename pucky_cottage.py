...
class CottageView:
    ...
    def _draw_room_overlays_idunn(self, surf, W, H, t):
        ...
        fx_c = int(W * 620/800) + 50
        fy_b = int(H * 310/480) - 65
        for i in range(7):
            ft   = t*2.1 + i*0.75
        ...
        for bname, blabel, (bc,bc2), bx2, by2 in [
            ("memory","Mem",BOOK_COLS["memory"], int(W*432/800)+25, int(H* 73/480)),
            ("story", "Sto",BOOK_COLS["story"],  int(W*460/800)+25, int(H* 73/480)),
            ("canvas","Ske",BOOK_COLS["canvas"],  int(W*432/800)+25, int(H*135/480)),
        ]:
